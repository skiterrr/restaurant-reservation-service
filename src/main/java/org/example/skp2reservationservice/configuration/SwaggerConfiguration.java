...
//
//import org.example.skp2reservationservice.controller.RestaurantController;
...
//                .select().apis(RequestHandlerSelectors.basePackage(RestaurantController.class.getPackage().getName()))
//                .build()
//                .apiInfo(metaData());
//    }
//
